...
public class EGClientProxy extends EGCommonProxy
{
	...
	public void registerRenderEntity()
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(Mosasaurus.class, new RenderMosasaurus(0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(Brachiosaurus.class, new RenderBrachiosaurus(0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(Ankylosaurus.class, new RenderAnkylosaurus(new ModelAnkylosaurus(), 0.75F));
