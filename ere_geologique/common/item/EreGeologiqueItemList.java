...
public class EreGeologiqueItemList
{
	...
	{
		   PrehistoriqueCoal = new PrehistoriqueCoal(EreGeologique.PrehistoriqueCoalID).setIconIndex(0).setUnlocalizedName("CoalPrehistorique");
	       FougereSeeds = new FougereSeeds(EreGeologique.FougereSeedsID).setIconIndex(1).setUnlocalizedName("Fougere");
	       FougereSword = new FougereSword(EreGeologique.FougereSwordID, materielFougere).setIconIndex(2).setUnlocalizedName("FougereSword");
	       FougerePickaxe = new FougerePickaxe(EreGeologique.FougerePickaxeID, materielFougere).setIconIndex(3).setUnlocalizedName("FougerePickaxe");
	       FougereAxe = new FougereAxe(EreGeologique.FougereAxeID, materielFougere).setIconIndex(4).setUnlocalizedName("FougereAxe");
	       FougereShovel = new FougereShovel(EreGeologique.FougereShovelID, materielFougere).setIconIndex(5).setUnlocalizedName("FougereShovel");
	       FougereHoe = new FougereHoe(EreGeologique.FougereHoeID, materielFougere).setIconIndex(6).setUnlocalizedName("FougereHoe");
	       FougereHelmet = new armureFougere(EreGeologique.FougereHelmetID, armureFougere,0,0).setIconIndex(7).setUnlocalizedName("FougereHelmet");
	       FougereChestplate = new armureFougere(EreGeologique.FougereChestplateID, armureFougere,1,1).setIconIndex(8).setUnlocalizedName("FougereChestplate");
	       FougereLeggings = new armureFougere(EreGeologique.FougereLeggingsID, armureFougere,2,2).setIconIndex(9).setUnlocalizedName("FougereLeggings");
	       FougereBoots = new armureFougere(EreGeologique.FougereBootsID, armureFougere,3,3).setIconIndex(10).setUnlocalizedName("FougereBoots");
	       PrehistoriqueCoalDust = new PrehistoriqueCoal(EreGeologique.PrehistoriqueCoalDustID).setIconIndex(11).setUnlocalizedName("CoalDustPrehistorique");
	       CoalLiquidItem = new PrehistoriqueCoal(EreGeologique.CoalLiquidItemID).setIconIndex(12).setUnlocalizedName("CoalLiquidItem");
	       PrehistoriqueCharCoal = new PrehistoriqueCoal(EreGeologique.PrehistoriqueCharCoalID).setIconIndex(13).setUnlocalizedName("PrehistoriqueCharCoal");
	       PrehistoriqueCokeCoal = new PrehistoriqueCoal(EreGeologique.PrehistoriqueCokeCoalID).setIconIndex(14).setUnlocalizedName("PrehistoriqueCokeCoal");
	       PrehistoriqueIronIngot = new PrehistoriqueIronIngot(EreGeologique.PrehistoriqueIronIngotID).setIconIndex(15).setUnlocalizedName("PrehistoriqueIronIngot"); 
	       IvoryIngot = new IvoryIngot(EreGeologique.IvoryIngotID).setIconIndex(16).setUnlocalizedName("IvoryIngot");
	       IvoryNugget = new IvoryIngot(EreGeologique.IvoryNuggetID).setIconIndex(17).setUnlocalizedName("IvoryNugget");
	       IvoryGear = new IvoryIngot(EreGeologique.IvoryGearID).setIconIndex(18).setUnlocalizedName("IvoryGear");
	       CoalLiquidBucket = new PrehistoriqueCoalBucket(EreGeologique.CoalLiquidBucketID).setIconIndex(19).setUnlocalizedName("CoalLiquidbucket");
	       FruitFougere = new FruitFougere(EreGeologique.FruitFougereID).setIconIndex(20).setUnlocalizedName("FruitFougere");
