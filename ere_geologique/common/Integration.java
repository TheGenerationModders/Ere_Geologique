...
public class Integration
{
	public static void loadIndustrialCraft()
	{
	 ...
	 Ic2Recipes.addExtractorRecipe(new ItemStack(EreGeologiqueBlockList.FougereWood), new ItemStack(EreGeologiqueItemList.PrehistoriqueCoal));
	}
	...
	public static void loadRailCraft()
	{
	 ...
	 RailcraftCraftingManager.cokeOven.addRecipe(new ItemStack(EreGeologiqueBlockList.FougereWood), new ItemStack(EreGeologiqueItemList.PrehistoriqueCharCoal), LiquidDictionary.getLiquid("CoalLiquid", 250), 3000);
	}

	public static void loadForestry()
	{
	 forestry.api.recipes.RecipeManagers.squeezerManager.addRecipe(10, new ItemStack[]{new ItemStack(EreGeologiqueBlockList.FougereWood)}, LiquidDictionary.getLiquid("CoalLiquid", 200), new ItemStack(EreGeologiqueBlockList.FougerePlank,4), 100);
	 forestry.api.fuels.FuelManager.bronzeEngineFuel.put(new ItemStack(EreGeologiqueItemList.CoalLiquidItem), new EngineBronzeFuel(new ItemStack(EreGeologiqueItemList.CoalLiquidItem), EreGeologique.FCoalLiquidMJ, EreGeologique.FCoalLiquidDurability, 1));
	}
