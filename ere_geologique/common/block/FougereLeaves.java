...
public class FougereLeaves extends BlockLeavesBase implements IShearable
{
	private int baseIndexInPNG;
    int[] adjacentTreeBlocks;
 
    public FougereLeaves(int par1, int par2, boolean useFastGraphics)
    {
    ...
    {
        return EreGeologique.FougereSaplingID;
    }
