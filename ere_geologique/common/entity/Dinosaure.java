...
//                this.getTexture = this.getModelTexture();
    ...
    {		
    	p0.reset();
    	p0.PrintPictXY(new ResourceLocation("ere_geologique:textures/items/"+ this.SelfType.toString() +"_DNA.png"), 175, 7, 16, 16);
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        else
        {
            ...
            if (var2 != null)
            {
            	...
            	*/
            	if (var2.itemID == EGItemList.ChickenEss.itemID && !var1.worldObj.isRemote)
            	...
            	else//no food, but not nothing
            	{
            		...
            		if(this.SelfType.canCarryItems()&& var2.itemID != EGItemList.DinoPedia.itemID && this.ItemInMouth == null && ((this.isTamed() && var1.username.equalsIgnoreCase(this.getOwnerName())) || (new Random()).nextInt(40)==1 ))
