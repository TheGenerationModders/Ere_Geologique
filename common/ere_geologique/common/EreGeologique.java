...
@Mod(modid = "ere_geologique", name = "Ere G\351ologique", version = Version.VERSION, dependencies = "required-after:Forge@[9.10.1.870,)")
@NetworkMod(clientSideRequired = true, serverSideRequired = false,
serverPacketHandlerSpec = @SidedPacketHandler(channels = {"EreGeologique"}, packetHandler = ServerPacketHandler.class))
...
public class EreGeologique
{
	...
	public void preload(FMLPreInitializationEvent event)
	{
		...
		try
		{
			...
			Property updateCheck = ConfigFile.get(Configuration.CATEGORY_GENERAL, "update.check", true);
