...
public class WaterDinoAISwimming extends EntityAIBase
{
    ...
    public WaterDinoAISwimming(Dinosaure var1, boolean var2, float var3, float var4)
    {
    ...
    public WaterDinoAISwimming(Dinosaure var1, boolean var2, float var3)
    {
    ...
    protected void controlSurfacing()
    {
        ...
        for (int var6 = 0; var6 < var1; ++var6)
        {
            ...
            if (this.entity.worldObj.isAABBInMaterial(var11, Material.field_151586_h))
            {
