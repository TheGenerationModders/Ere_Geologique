...
public class Dilophosaurus extends Dinosaure
{
    ...
    public Dilophosaurus(World var1)
    {
...
//                	        // Movement Speed - default 0.699D - min 0.0D - max Double.MAX_VALUE
    ...
    public Dilophosaurus spawnBabyAnimal(EntityAgeable var1)
    {
        return new Dilophosaurus(this.worldObj);
    }
    ...
    public void setTarget(Entity var1)
    {
        ...
        //this.CheckSkin();
        // change the skin to the aggressive one==>could be handled in gettexture
    }
