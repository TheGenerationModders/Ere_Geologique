...
import ere_geologique.common.gui.elements.EGGuiButton;
import ere_geologique.common.gui.elements.GuiPage;
import ere_geologique.common.gui.elements.dinosaures.PediaDinosaure;

public class GuiNotebook extends GuiScreen
{
    
    private static final ResourceLocation notebook_background = new ResourceLocation("ere_geologique:textures/gui/Arch_Notebook.png");
    ...
    public GuiPage buttonNextPage;
    public GuiPage buttonPreviousPage;
    public int BookPages;
    public int BookPagesTotal = 1;
    public EGGuiButton buttonIcon;
	...
	public void initGui()
	{
        ...
        this.buttonList.add(this.buttonNextPage = new GuiPage(0, var1 + 200, var2 + 140, true, BookPages));
        this.buttonList.add(this.buttonPreviousPage = new GuiPage(1, var1 + 30, var2 + 140, false, BookPages));
	...
	public void addButtonByPage(int page)
	{
		...
		*/
		...
		if(page == 0)
		{
	        this.buttonList.add(this.buttonIcon = new EGGuiButton(2, var1+35, var2+55, 0));
	        this.buttonList.add(this.buttonIcon = new EGGuiButton(3, var1+75, var2+55, 2));
	        this.buttonList.add(this.buttonIcon = new EGGuiButton(4, var1+115, var2+55, 4));
	        this.buttonList.add(this.buttonIcon = new EGGuiButton(5, var1+55, var2+95, 6));
	        this.buttonList.add(this.buttonIcon = new EGGuiButton(6, var1+95, var2+95, 8));
		}
	}
