...
//    public int leftLeftAlign = 140; //Left aligntment position for text on the LEFT page of the pedia
    ...
    {
    	this.fontRendererObj.drawString(str0, 59+(left0? 0 : 81), 12*(line+1), 4210752);
    }
    public void PrintStringLR(String str0,boolean left0,int line,int r,int g,int b)
    {
    	int col=(r << 16) | (g << 8) | b;
    	this.fontRendererObj.drawString(str0, 59+(left0? 0 : 81), 12*(line+1), col);
    }
    ...
    {
    	this.fontRendererObj.drawString(str0, 24+(left0? 0 : 81), 12*((left0?this.left++:this.right++)+1), 4210752);
    }
    public void AddStringLR(String str0,boolean left0,int r,int g,int b)
    {
    	int col=(r << 16) | (g << 8) | b;
    	this.fontRendererObj.drawString(str0, 24+(left0? 0 : 81), 12*((left0?this.left++:this.right++)+1), col);
    }
    /**
